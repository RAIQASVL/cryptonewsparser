...
export class BeInCryptoParser extends BaseParser {
  constructor(options: ParserOptions) {
    super("beincrypto", beInCryptoConfig, options);
    this.logMessage("BeInCryptoParser initialized");
  }
  ...
  protected async extractNewsItems(): Promise<NewsItem[]> {
    ...
    try {
      ...
      if (blockCheck.blocked) {
        this.logMessage(`Access blocked: ${blockCheck.reason}`, "warn");
      ...
      this.logMessage(`Found ${newsItems.length} news items`, "info");
