...
// async function processValidatedMessages(
//   validations: Record<number, boolean>,
//   messages: { id: number; text: string; channel: string; date: Date }[]
// ) {
...
//       try {
//         console.log(
//           `Processing message ${message.id}: ${message.text.substring(
//             0,
//             100
//           )}...`
//         );
...
//     const processedPosts = await processValidatedMessages(
//       validations,
//       messagesToValidate
//     );
//     const nextCheck = moment()
//       .add(API_CONFIG.CHECK_INTERVAL / 1000, "seconds")
//       .format("HH:mm:ss");
//     console.log(
//       `Successfully processed ${processedPosts.length} posts. Next check at ${nextCheck}`
//     );
...
//             });
//             console.log(
//               `Saved new forward post from ${channelName} (ID: ${
//                 channel.id
//               }), message ID: ${message.id}, has media: ${!!mediaInfo}`
//             );
//           }
//         }
//       }
...
//   console.log(
//     `- GET http://localhost:${API_CONFIG.PORT}/api/posts/latest?timeWindow=60`
//   );
